...
DECOMPOSITION_PROMPT_VERSION = "task-decomposition-v5"
...
The first subtask must use suggested_sequence 1, the second 2, and so on; never use 0. priority must echo selected_task.user_priority exactly; the application owns and validates that inherited default.
