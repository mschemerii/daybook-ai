...
def load_runtime_config(
    ...
    return RuntimeConfig(
        ...
        model_port=int(os.getenv("DAYBOOK_MODEL_PORT", "88080")),
        streamlit_host=os.getenv("DAYBOOK_STREAMLIT_HOST", "127.0.0.1"),
        streamlit_port=int(os.getenv("DAYBOOK_STREAMLIT_PORT", "88501")),
        controller_host=os.getenv("DAYBOOK_CONTROLLER_HOST", "127.0.0.1"),
        controller_port=int(os.getenv("DAYBOOK_CONTROLLER_PORT", "88500")),
